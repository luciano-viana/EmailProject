...
public class EmailLayout {
	...
	//Constante "Constantes são como variáveis, só que com o ponto de que seu valor não pode ser modificado"
	...
	public Email montarEmailAdministrador(String destinataria, String assunto) {
		...
		texto
		    .append("A/C Administrador")//Assunto email
			.append(QUEBRA_DE_LINHA_DUPLA);
		
		texto
			.append("Solicito alteração de senha do sistema!")//Corpo email
			.append(QUEBRA_DE_LINHA_DUPLA);
	...
	public Email montarEmailSecretaria(String destinataria, String assunto) {
		...
		texto
		    .append("A/C Secretário")//Assunto email
			.append(QUEBRA_DE_LINHA_DUPLA);
		
		texto
			.append("Texto personalizado para secretário!")//Corpo email
			.append(QUEBRA_DE_LINHA_DUPLA);
